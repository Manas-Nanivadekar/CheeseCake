        ...
        <div className="relative">
            ...
            <section className="bg-[#FFFC6D] pt-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center pb-48"> {/* Added padding bottom for video overlap */}
                        <h1 className="text-4xl font-bold tracking-tight text-[#0A0B1F] sm:text-5xl md:text-6xl">
                            ...
                            <span className="block mt-2">Gamify your learning experience.</span>
                        </h1>
                        <p className="mx-auto mt-6 max-w-2xl text-lg text-[#0A0B1F]/80 flex">
                            Start now and supercharge learning experiences like its a piece of{' '}Cheese Cake!
                            <img className="ml-2" src="https://res.cloudinary.com/dnvh2fya6/image/upload/v1736544667/cheese_aen61j.png" alt="" height={20} width={30} />
                            {/* <HighlightBox color="bg-[#BA8E23] ml-2 scale-110 font-semibold gap-3 flex">Cheese Cake!
            ...
            <div className="absolute left-1/2 -translate-x-1/2 w-full max-w-2xl px-4" style={{ top: '38%' }}>
            ...
            <section className="bg-[#f7f8fa] pt-52">
                <div className="container mx-auto px-4 py-24">
                    <h1 className="mx-auto max-w-5xl text-center text-3xl font-bold leading-tight md:text-5xl">
                        ...
                        <HighlightBox color="bg-[#3EEEC0]">generate </HighlightBox>{' '}
                        engaging pathways and engaging courses with{' '}
                        <HighlightBox color="bg-[#94a4ff]">gamified twists</HighlightBox>{' '}
                        to help students learn and also compete based on our{' '}
